...
struct jtag_ops jtag0_ops = {
    _ast_jtag_open,     _ast_jtag_close,    _ast_jtag_set_mode,
    _ast_get_jtag_freq, _ast_set_jtag_freq, _ast_jtag_run_test_idle,
    _ast_jtag_sir_xfer, _ast_jtag_tdo_xfer, _ast_jtag_tdi_xfer};
