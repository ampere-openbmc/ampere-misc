...
namespace Control
{
	namespace Power
	{
		...
		{
			using powerCapClass =
				phosphor::Control::Power::Cap::PowerCap;
			class PowerManager {
			    public:
				PowerManager() = delete;
				PowerManager(const PowerManager &) = delete;
				PowerManager &
				operator=(const PowerManager &) = delete;
				PowerManager(PowerManager &&) = delete;
				PowerManager &
				operator=(PowerManager &&) = delete;
				...
				std::unique_ptr<powerCapClass> capObject =
					nullptr;
