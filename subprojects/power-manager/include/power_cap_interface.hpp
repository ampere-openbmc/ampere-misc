...
using CapClass = sdbusplus::xyz::openbmc_project::Control::Power::server::Cap;
...
namespace Control
{
     ...
     */
				CapClass::ExceptionActions exceptionAction(
					ExceptionActions value) override;
     ...
     */
				uint64_t
				correctionTime(uint64_t value) override;
     ...
     */
				uint64_t
				samplingPeriod(uint64_t value) override;
