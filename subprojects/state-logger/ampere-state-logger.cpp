...
int main(int argc, char *argv[])
{
	...
	sdbusplus::bus::match::match hostStateMonitor =
		startHostStateMonitor(conn);
	sdbusplus::bus::match::match powerGoodMonitor =
		startPowerGoodMonitor(conn);
	io.run();
